        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <AnimateInView animation="scale-in" delay={300}>
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              <div className="w-[90%] h-[90%] rounded-full border-2 border-accent/30 absolute top-[5%] left-[5%] animate-pulse-subtle" style={{ animationDelay: '1s' }}></div>
              <div className="w-[80%] h-[80%] rounded-full border-2 border-accent/40 absolute top-[10%] left-[10%] animate-pulse-subtle" style={{ animationDelay: '2s' }}></div>
